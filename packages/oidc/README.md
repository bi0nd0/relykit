...
The package implements discovery, Authorization Code flow with S256 PKCE, state and nonce validation, token verification, optional UserInfo, configurable token-endpoint client authentication, structured state-bound RP-initiated logout form requests, safe return paths, and pure access decisions.
